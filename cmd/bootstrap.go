...
var bootstrapCmd = &cobra.Command{
	Use:   "bootstrap",
	Short: "Generate initial repository structure",
	Long:  `Generate initial repository structure`,
...
func init() {
	...
	bootstrapCmd.PersistentFlags().Bool("dry-run", false, "Dry run only (do not output files)")
	bootstrapCmd.PersistentFlags().Bool("list", false, "Output list of plugins and exit")
